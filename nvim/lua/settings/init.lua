...
-- TODO: set iskeyword+=- -- treat dash separated words as a word text object"
vim.opt.splitbelow = true -- Horizontal splits will automatically be below
vim.opt.splitright = true -- Vertical splits will automatically be to the right
-- TODO: set t_Co=256     -- Support 256 colors
...
-- TODO: set formatoptions-=cro                  " Stop newline continution of comments
...
-- TODO: set wildmode=list:longest,full  " command <Tab> completion
-- TODO: set whichwrap=b,s,h,l,<,>,[,]   " backspace and cursor keys wrap to
vim.opt.scrolljump = 5 -- lines to scroll when cursor leaves screen
-- TODO: syntax on                       " enable syntax highlighting
